...
function SignInForm() {
  return (
  <div className="flex mx-auto bg-white w-1/3 h-1/2 rounded-xl justify-center flex-col z-50">
    ...
    <div className="w-full h-1/6 flex justify-end">
      <div className="h-full w-1/2"><a href="#" className="flex justify-center items-start w-full text-gray-500">forgot password?</a></div> 
    </div>
