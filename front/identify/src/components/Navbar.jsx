    ...
    <nav class="bg-transparent border-gray-200 sm:px-20 py-2.5 rounded md:px-10 h-1/6 items-center flex">
      <div class="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div class="flex w-1/2 justify-end space-x-6">
          <button
            type="button"
            class="font-font1 font-thin text-white text-base rounded-xl px-5 py-2 border border-sea hover:bg-mypurple hover:text-black hover:font-thin hover:shadow-black hover:shadow-md"
          >
            Get started
          </button>
          <button
            type="button"
            class="font-font1 font-bold text-black text-base rounded-xl px-8 bg-white hover:shadow-black hover:shadow-md"
          >
            Sign in
          </button>
        </div>
