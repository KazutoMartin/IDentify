  ...
  return (
    <nav class="bg-transparent border-gray-200 px-2 sm:px-4 py-2.5 rounded">
      ...
      <a href="#" class="flex items-center">
          ...
          <span class="self-center text-2xl font-logo font-bold text-white whitespace-nowrap dark:text-black">IDENTIFY</span>
      </a>
      ...
      <button type="button" class="ml-1 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign in</button>
