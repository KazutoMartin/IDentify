...
class LinkedIn(models.Model):
    ...
    summary = models.TextField(_("Summary"), max_length=2001, null=True, blank=True)
    ...
    industry_name = models.CharField(_("Industry"), max_length=20, null=True, blank=True)
    is_student = models.BooleanField(_("Is Student"), default=False)
    headline = models.CharField(_("Headline"), max_length=200, null=True, blank=True)
    school = models.CharField(_("School"), max_length=20, null=True, blank=True)
    degree = models.CharField(_("Degree"), max_length=20, null=True, blank=True)
    study_field = models.CharField(_("Study field"), max_length=20, null=True, blank=True)
